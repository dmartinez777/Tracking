...
Route::get('/test', 'EventsTestController@index'); // hiring event listings page
...
Route::get('/test/e/{event_id}', 'EventsTestController@eventInfo')->where('event_id', '([0-9]+)'); // hiring event page
